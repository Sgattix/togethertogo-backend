...
exports.TaskActivityDto = exports.TaskCommentDto = exports.CreateCommentDto = exports.UpdateTaskDto = exports.CreateTaskDto = void 0;
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['pending', 'in_progress', 'completed', 'blocked']),
    __metadata("design:type", String)
...
exports.TaskActivityDto = TaskActivityDto;
